...
func (*ClassifyLog) Descriptor() ([]byte, []int) {
	return fileDescriptor_prediction_log_c41c8597da0fe37b, []int{0}
}
...
func (dst *ClassifyLog) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ClassifyLog.Merge(dst, src)
}
...
func (*RegressLog) Descriptor() ([]byte, []int) {
	return fileDescriptor_prediction_log_c41c8597da0fe37b, []int{1}
}
...
func (dst *RegressLog) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RegressLog.Merge(dst, src)
}
...
func (*PredictLog) Descriptor() ([]byte, []int) {
	return fileDescriptor_prediction_log_c41c8597da0fe37b, []int{2}
}
...
func (dst *PredictLog) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PredictLog.Merge(dst, src)
}
...
func (*MultiInferenceLog) Descriptor() ([]byte, []int) {
	return fileDescriptor_prediction_log_c41c8597da0fe37b, []int{3}
}
...
func (dst *MultiInferenceLog) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MultiInferenceLog.Merge(dst, src)
}
...
func (*SessionRunLog) Descriptor() ([]byte, []int) {
	return fileDescriptor_prediction_log_c41c8597da0fe37b, []int{4}
}
...
func (dst *SessionRunLog) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SessionRunLog.Merge(dst, src)
}
...
func (*PredictionLog) Descriptor() ([]byte, []int) {
	return fileDescriptor_prediction_log_c41c8597da0fe37b, []int{5}
}
...
func (dst *PredictionLog) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PredictionLog.Merge(dst, src)
}
...
func (m *PredictionLog) GetLogMetadata() *core.LogMetadata {
	if m != nil {
...
func init() {
	proto.RegisterFile("tensorflow_serving/apis/prediction_log.proto", fileDescriptor_prediction_log_c41c8597da0fe37b)
}

var fileDescriptor_prediction_log_c41c8597da0fe37b = []byte{
