...
func (*SavedModel) Descriptor() ([]byte, []int) {
	return fileDescriptor_saved_model_8def30d414266ffe, []int{0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/protobuf/saved_model.proto", fileDescriptor_saved_model_8def30d414266ffe)
}

var fileDescriptor_saved_model_8def30d414266ffe = []byte{
