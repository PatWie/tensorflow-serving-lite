...
func (*NodeDef) Descriptor() ([]byte, []int) {
	return fileDescriptor_node_def_9fc8e0eca67f783f, []int{0}
}
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/node_def.proto", fileDescriptor_node_def_9fc8e0eca67f783f)
}

var fileDescriptor_node_def_9fc8e0eca67f783f = []byte{
